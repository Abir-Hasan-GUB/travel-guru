...
if(firebase.apps.length === 0){
         ...
         <HeaderTwo></HeaderTwo>
            { !newUser && <div className="loginPanel">
                ...
                <form onSubmit={handleSubmit}>
                    <input onBlur={handleBlur} className="userName" placeholder="Username or Email" type="text" name="email" id="" /> <br />
                    <input onBlur={handleBlur} className="userName" placeholder="Password" type="password" name="password" id="" /> <br />
                    ...
                    <p className="rememberMe footerText">Don’t have an account?
                        <a onClick = {()=> setNewUser (!newUser)} href="#" className="forgotPass" name="newUser">  Create an account </a></p>
                </form>
            </div>}
    ...
    {newUser &&  <div className="loginPanel loginPanelTwo">
        ...
        <p>password: {user.password}</p> */}
                ...
                <h4 className="loginTitle">Login</h4>
                <form onSubmit={handleSubmit}>
                    <input onBlur={handleBlur} className="userName userNameTwo" placeholder="First Name" type="text" name="firstName" id="" required /> <br />
                    <input onBlur={handleBlur} className="userName userNameTwo" placeholder="Last Name" type="text" name="lastName" id="" required /> <br />
                    <input onBlur={handleBlur} className="userName userNameTwo" placeholder="Username or Email" type="text" name="email" id="" required /> <br />
                    <input onBlur={handleBlur} className="userName userNameTwo" placeholder="Password" type="password" name="password" id="" required /> <br />
                    <input className="userName userNameTwo" placeholder="Confirm Password" type="password" name="confirmPassword" id="" required /> <br />
            ...
            {user.success &&  <p className = "responseMessage" style={{ color: 'green' }}> User {newUser ?'Create' : 'Logged In'} Successfully</p> }
        </div>
    );
};
